...
{:else if icon === "Image"}
	...
	>
{:else if icon === "PDF"}
	<svg xmlns="http://www.w3.org/2000/svg" {width} {height} viewBox="0 0 16 16"
		><path
			fill="current"
			fill-rule="evenodd"
...
{:else if icon === "Skill"}
	<svg xmlns="http://www.w3.org/2000/svg" {width} {height} viewBox="0 0 32 32"
		><path fill="current" d="M30 30h-8V4h8zm-6-2h4V6h-4zm-4 2h-8V12h8zm-10 0H2V18h8z" /></svg
	>
...
{:else if icon === "Plus"}
	<svg xmlns="http://www.w3.org/2000/svg" {width} {height} viewBox="0 0 24 24"
		><path fill="current" d="M11 13H5v-2h6V5h2v6h6v2h-6v6h-2v-6Z" /></svg
	>
{:else if icon === "AI"}
	<svg xmlns="http://www.w3.org/2000/svg" {width} {height} viewBox="0 0 24 24"
		><path
